...
# PREPROCESSING #
#################
if [[ ($CONTINUE_PROCESSES -eq 1 || $CONTINUE_PROCESSES -eq 0) && ($EXIT_AFTER_PROCESS -eq 0 || $EXIT_AFTER_PROCESS -ge 1) ]]; then 
...
# RECONSTRUCTION #
##################
if [[ ($CONTINUE_PROCESSES -eq 2 || $CONTINUE_PROCESSES -eq 0) && ($EXIT_AFTER_PROCESS -eq 0 || $EXIT_AFTER_PROCESS -ge 2) ]]; then
...
# REPLACE #
###########
if [[ ($CONTINUE_PROCESSES -eq 3 || $CONTINUE_PROCESSES -eq 0) && ($EXIT_AFTER_PROCESS -eq 0 || $EXIT_AFTER_PROCESS -ge 3) ]]; then
...
############################
if [[ ($CONTINUE_PROCESSES -eq 4 || $CONTINUE_PROCESSES -eq 0) && ($EXIT_AFTER_PROCESS -eq 0 || $EXIT_AFTER_PROCESS -ge 4) ]]; then
...
########################################################
if [[ ($CONTINUE_PROCESSES -eq 5 || $CONTINUE_PROCESSES -eq 0) && ($EXIT_AFTER_PROCESS -eq 0 || $EXIT_AFTER_PROCESS -ge 5) ]]; then
...
# VISUALIZATIONS #
##################
if [[ ($CONTINUE_PROCESSES -eq 6 || $CONTINUE_PROCESSES -eq 0) && ($EXIT_AFTER_PROCESS -eq 0 || $EXIT_AFTER_PROCESS -ge 6) ]]; then
